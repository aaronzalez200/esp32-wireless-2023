...
// NVS name space used for serial number
const char SERIAL_KEY[] = "serial_number";

// NVS name space used for MAC address
const char app_nvs_mac_addr_namespace[] = "storage";

// NVS name space used for station mode credentials
const char app_nvs_sta_creds_namespace[] = "stacreds";

esp_err_t app_nvs_save_unique_id(void)
{
    nvs_handle handle;
    esp_err_t esp_err;
    ESP_LOGI(TAG, "app_nvs_save_unique_id: Saving unique serial to flash");
    return ESP_OK;
}
...
esp_err_t app_nvs_save_sta_creds(void)
{
    ...
    printf("app_nvs_save_sta-Creds: returned ESP_OK\n");
    return ESP_OK;
}
...
bool app_nvs_load_sta_creds(void)
{
    ...
    ESP_LOGI(TAG, "app_nvs_load-sta_creds: Loading Wifi credentials from flash");
